...
public class ServletFruta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Fruta fru = new Fruta(idfruta,desc);
            
            //Se crea JSON que contiene datos de la Fruta
            Gson gson = new Gson();
            String JSON = gson.toJson(fru);
            String alert = null;
            
           if(this.createFruit(JSON) == false){
               alert = "Error";
               response.sendRedirect("crearFurta.jsp");
           }else{
              alert = "EXITO";
